import AElf from 'aelf-sdk';  // 引入

const { sha256 } = AElf.utils;

const wallet = AElf.wallet.createNewWallet();  // 创建一个新钱包，还可以根据
//const priviteKeyWallet = AElf.wallet.getWalletByPrivateKey('xxxxxxx');  // 根据私钥
//const mnemonicWallet = AElf.wallet.getWalletByMnemonic('set kite ...');  // 根据助记符

const aelf = new AElf(new AElf.providers.HttpProvider('http://127.0.0.1:1235'));  //创建实例，连接到一个AElf链节点
